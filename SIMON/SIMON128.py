            ...
            for m in range(0, length):
                ...
                for j in range(0, len(line_split)):
                    ...
                    if line_split[j] == "αy_c2":
                        constraint.append("dict[a[(i+7)%64] + str(\"_c2\")]")
                    if line_split[j] == "αy_c1":
                        constraint.append("dict[a[(i+7)%64] + str(\"_c1\")]")
                    if line_split[j] == "αy_c0":
                        constraint.append("dict[a[(i+7)%64] + str(\"_c0\")]")
                    if line_split[j] == "αy_c2'":
                        constraint.append("-dict[a[(i+7)%64] + str(\"_c2\")]")
                    if line_split[j] == "αy_c1'":
                        constraint.append("-dict[a[(i+7)%64] + str(\"_c1\")]")
                    ...
                    if line_split[j] == "Pdep":
                        constraint.append("dict[d[(i-1)%64] + str(\"_Pdep\")]")
                    if line_split[j] == "Pdep'":
                        constraint.append("-dict[d[(i-1)%64] + str(\"_Pdep\")]")
                constraint_real = []
...
for i in range(1, 33):
    ...
    if i == 1:
        ...
        copy(genVars_Round(i - 1)[0:64], Rin)
...
gen_objectfunction2_Constraint(32, 0, vars_num)
